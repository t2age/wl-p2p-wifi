Tutorial 3 - Internet Router Bridge
...
----------------------------------------------------------------------
3.1.0 WiFi between 2 peers (or more).
----------------------------------------------------------------------

-----
3.1.1 Install hostapd software
-----
...
-----
3.1.2 Create/Modify hostapd configuration file (/etc/hostapd/hostapd.conf)
-----
...
-----
3.1.3 Edit the file /etc/hostapd, modify the variable "DAEMON_CONF".
-----
...
-----
3.1.4 Edit the file /etc/dhcpcd.conf, give the WIFI an static IP Address
-----
...
-----
3.1.5 Start/Restart hostapd service
-----
